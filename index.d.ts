...
/**
@param altitude - Altitude to return properties from
@example
```
...
declare interface AtmosphericProperties {
...
declare function standardAtmosphere(altitude: number, options?: boolean): AtmosphericProperties;
